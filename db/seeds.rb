...
sam_harris = Author.create(first_name: "Sam", middle_name: "Benjamin", last_name: "Harris", bio: "Samuel Benjamin Harris is an American neuroscientist, author, critic of religion, blogger, public intellectual, and podcast host")
...
patrick_rothfuss = Author.create(first_name: "Patrick", middle_name: "James", last_name: "Rothfuss", bio: "Patrick James Rothfuss is an American writer of epic fantasy. He is best known for his series The Kingkiller Chronicle, which won him several awards, including the 2007 Quill Award for his debut novel, The Name of the Wind. Its sequel, The Wise Man's Fear, topped The New York Times Best Seller list")
