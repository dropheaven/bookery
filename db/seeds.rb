...
james_clear.books.create(title: "Atomic Habits", release_date: 2018, genre: self_dev)
...
patrick_rothfuss.books.create(title: "The Wise Man's Fear", release_date: 2011, genre: fantasy)
...
dan_brown.books.create(title: "Origin", release_date: 2017, genre: thriller)
dan_brown.books.create(title: "The Da Vinci Code", release_date: 2003, genre: thriller)
dan_brown.books.create(title: "Angels & Demons", release_date: 2000, genre: thriller)
dan_brown.books.create(title: "The Lost Symbol", release_date: 2009, genre: thriller)
