...
yuval = Author.create(first_name: "Yuval", middle_name: "Noah", last_name: "Harari", bio: "Yuval Noah Harari is an Israeli historian and a tenured professor in the Department of History at the Hebrew University of Jerusalem. He is the author of the international bestsellers Sapiens: A Brief History of Humankind, Homo Deus: A Brief History of Tomorrow, and 21 Lessons for the 21st Century")
...
sam_harris = Author.create(first_name: "Sam", last_name: "Harris", bio: "Samuel Benjamin Harris is an American neuroscientist, author, critic of religion, blogger, public intellectual, and podcast host")
...
nk_jemisin = Author.create(first_name: "N.K.", last_name: "Jemisin", bio: "Nora K. Jemisin is an American science fiction and fantasy writer and a psychologist. Her fiction explores a wide variety of themes, including cultural conflict and oppression. She has won several awards for her work, including the Locus Award.")
...
patrick_rothfuss = Author.create(first_name: "Patrick", last_name: "Rothfuss", bio: "Patrick James Rothfuss is an American writer of epic fantasy. He is best known for his series The Kingkiller Chronicle, which won him several awards, including the 2007 Quill Award for his debut novel, The Name of the Wind. Its sequel, The Wise Man's Fear, topped The New York Times Best Seller list")
